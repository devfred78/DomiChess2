...
class PlayerPanel(tk.LabelFrame):
    ...
    def __init__(self, parent, player_color, engine_paths, display_piece):
        ...
        # The content of the CPU tab is now built by update_engine_list
    ...
    def update_engine_list(self, engine_paths):
        ...
        # Clear previous widgets in CPU tab
        ...
        # Important: Recreate the OptionMenu with the new list
        ...
        # Trigger the check for the initially selected engine
    ...
    def _on_engine_selected(self, *args):
        # This check is important because this can be called during widget destruction
